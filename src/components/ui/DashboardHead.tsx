...
const DashboardHead = () => {
    return (
          <div className="h-20 grid grid-cols-12  absolute w-[calc(100%-310px)] fixed hidden md:grid bg-white z-1">
                <div className="2xl:col-span-7 md:col-span-7 flex items-center ">
                    <input type="text" name="" id="" placeholder="Search assets" className="h-10 w-[50%] pl-5 rounded-full bg-secondary-text" />
                </div>
                <div className='2xl:col-span-5 md:col-span-5 grid items-center mr-5'>
                    <div className=''>
